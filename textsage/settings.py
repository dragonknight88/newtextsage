...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'textsage')
...
SECRET_KEY = '5xnnk#_s))ti$3hnazvd!6n_wdy%qnhl0&k@hh5j*2*$tb5c8='
...
ROOT_URLCONF = 'textsage.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'textsage.wsgi.application'
